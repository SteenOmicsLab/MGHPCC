...
#SBATCH --cpus-per-task=64		#Number of CPUS needed
#SBATCH --mem=120GB			#Memory needed	
...
#Run job
singularity exec --bind $inputdirectory,$outputdirectory,$fragpipeDirectory $container $1/settings/MSFragger.sh "$1" 