...
BoolFile=$(find "/project/Path-Steen/analysis/timstoffiles" -maxdepth 1 -name "*.d" | head -n 1)
...
do
	...
	brukerfiles1=$(find "/project/Path-Steen/analysis/timstoffiles" -maxdepth 1 -name "*.d" | head -n $N)
	echo $brukerfiles1
	...
	brukerfiles2=$(find "/project/Path-Steen/analysis/timstoffiles" -maxdepth 1 -name "*.d" | head -n $N)
	if [[ -n $brukerfiles2 ]]
	then
