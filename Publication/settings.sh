...
msfraggerPath="/tmp/msfragger"$SLURM_JOBID""$SLURM_ARRAY_TASK_ID"/MSFragger-20171106/MSFragger-3.3/MSFragger-3.3.jar" # download from http://msfragger-upgrader.nesvilab.org/upgrader/
msfraggerNetworkPath="/project/Path-Steen/msfragger/MSFragger-20171106/MSFragger-3.3/MSFragger-3.3.jar"
fraggerParamsNetworkPath="/project/Path-Steen/msfragger/fragger.params"
...
inputdirectory=/project/Path-Steen/analysis/timstoffiles_IMPACC/
outputdirectory=/project/Path-Steen/results/IMPACC_Phase123_SemiTryptic/
fastaFile=/project/Path-Steen/FASTA/2021-04-11-decoys-UP000005640_9606_SARS_COV_2.fasta.fas
