...
#SBATCH --time=240:00:00 #120:00:00 		#2 days. I have so far not seen it need more time.
...
#Run the Container
singularity exec --bind /project/:/project/ /project/Path-Steen/testy /project/Path-Steen/MGHPCC/ProteinProphet.sh  # $1
